...
public class CloudinaryService : ICloudinaryService
{
    ...
    public async Task<string> UploadImageAsync(IFormFile file, string folder = "products")
    {
        ...
        // Cloudinary free plan limit is 10MB per file
        if (file.Length > 10 * 1024 * 1024)
            throw new ArgumentException($"File size cannot exceed 10MB. Please compress the image before uploading. Current size: {file.Length / 1024 / 1024:F1}MB");
